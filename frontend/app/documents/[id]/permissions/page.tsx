...
export default function DocumentPermissionsPage({
  ...
  const handleRemovePermission = async (permissionId: string) => {
    try {
      await documentService.removeDocumentPermission(
        params.id,
        permissionId,
        user?._id || ""
      );
      ...
      <div className="container py-10">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground mt-1 mb-4">
            The document you are trying to manage permissions for does not exist
            or has been deleted.
          </p>
          <Button asChild>
            <Link href="/documents">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Control who can access "{document.title}"
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add or remove user permissions for this document
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
                            ...
                            <div className="col-span-4">
                              ...
                              >
                                {permission.permissionType
                                  .charAt(0)
                                  .toUpperCase() +
                                  permission.permissionType.slice(1)}
                              </span>
                            </div>
                            <div className="col-span-3">
                              <Button
